...
let website = document.getElementById("inp_website");
...
submit.onclick = function () {
    ...
    if (flag == 0)
        ...
        info.innerHTML = "<p>Name : " + name.value + "</p><p>Email : " + email.value +"</p><p>Website : " + website.value + "</p><p>Gender : " + selected + "</p><p>Skills : " + skillbox + "</p>";
